...
class CooperativeControllerTest : BaseRestDocsTest() {

    @Autowired
    private lateinit var cooperativeService: CooperativeService

    @Test
    @WithMockUser(authorities = ["PERMISSION_CREATE_COOPERATIVE"])
        ...
        mockMvc.perform(
            ...
            .andDo(
                document(
                    ...
                    requestFields(
                        fieldWithPath("code").description("Unique code/slug for the cooperative"),
                        ...
                        fieldWithPath("registrationNumber").description("Official registration number of the cooperative"),
                        fieldWithPath("point").description("Geographic point location (longitude, latitude)"),
                        ...
                        fieldWithPath("contactEmail").description("Primary contact email for the cooperative"),
                        fieldWithPath("contactPhone").description("Primary contact phone number"),
                        fieldWithPath("websiteUrl").description("Website URL of the cooperative"),
                        fieldWithPath("translation").description("Initial translation for the cooperative"),
                        fieldWithPath("translation.locale").description("Locale for this translation"),
                        fieldWithPath("translation.name").description("Localized name of the cooperative"),
                        fieldWithPath("translation.description").description("Localized detailed description of the cooperative"),
                        fieldWithPath("translation.location").description("Localized location description"),
                        fieldWithPath("translation.slugUrl").description("URL-friendly slug in this language"),
                        fieldWithPath("translation.status").description("Content status"),
                        fieldWithPath("translation.services").optional().description("Localized description of services offered"),
                        fieldWithPath("translation.achievements").optional().description("Localized description of key achievements"),
                        fieldWithPath("translation.operatingHours").optional().description("Localized operating hours information"),
                        fieldWithPath("translation.seoTitle").optional().description("SEO-optimized title in this language"),
                        fieldWithPath("translation.seoDescription").optional().description("SEO meta description in this language"),
                        fieldWithPath("translation.seoKeywords").optional().description("SEO keywords in this language"),
                        fieldWithPath("translation.structuredData").optional().description("JSON-LD structured data for this language version"),
                        fieldWithPath("translation.metaRobots").optional().description("Instructions for search engine crawlers")
                    ),
                    responseFields(
                        ...
                        fieldWithPath("data.id").description("Unique identifier for the cooperative"),
                        fieldWithPath("data.code").description("Unique code/slug for the cooperative"),
                        fieldWithPath("data.defaultLocale").description("Default locale for this cooperative's content"),
                        fieldWithPath("data.establishedDate").description("Date when the cooperative was established"),
                        fieldWithPath("data.ward").description("Ward where the cooperative is located"),
                        fieldWithPath("data.type").description("Type of cooperative"),
                        fieldWithPath("data.status").description("Status of the cooperative"),
                        fieldWithPath("data.registrationNumber").description("Official registration number of the cooperative"),
                        fieldWithPath("data.point").description("Geographic point location (longitude, latitude)"),
                        fieldWithPath("data.point.longitude").description("Longitude coordinate"),
                        fieldWithPath("data.point.latitude").description("Latitude coordinate"),
                        fieldWithPath("data.contactEmail").description("Primary contact email for the cooperative"),
                        fieldWithPath("data.contactPhone").description("Primary contact phone number"),
                        fieldWithPath("data.websiteUrl").description("Website URL of the cooperative"),
                        ...
                        fieldWithPath("data.translations").description("Translations for this cooperative"),
                        fieldWithPath("data.translations[].id").description("Unique identifier for the translation"),
                        fieldWithPath("data.translations[].locale").description("Locale for this translation"),
                        fieldWithPath("data.translations[].name").description("Localized name of the cooperative"),
                        fieldWithPath("data.translations[].description").description("Localized detailed description of the cooperative"),
                        fieldWithPath("data.translations[].location").description("Localized location description"),
                        fieldWithPath("data.translations[].services").description("Localized description of services offered"),
                        fieldWithPath("data.translations[].achievements").description("Localized description of key achievements"),
                        fieldWithPath("data.translations[].operatingHours").description("Localized operating hours information"),
                        fieldWithPath("data.translations[].seoTitle").description("SEO-optimized title in this language"),
                        fieldWithPath("data.translations[].seoDescription").description("SEO meta description in this language"),
                        fieldWithPath("data.translations[].seoKeywords").description("SEO keywords in this language"),
                        fieldWithPath("data.translations[].slugUrl").description("URL-friendly slug in this language"),
                        fieldWithPath("data.translations[].status").description("Content status"),
                        fieldWithPath("data.translations[].structuredData").description("JSON-LD structured data specific to this language version"),
                        fieldWithPath("data.translations[].canonicalUrl").description("Canonical URL for this language version"),
                        fieldWithPath("data.translations[].hreflangTags").description("Array of hreflang references to other language versions"),
                        fieldWithPath("data.translations[].breadcrumbStructure").description("JSON representation of breadcrumb structure for this page"),
                        fieldWithPath("data.translations[].faqItems").description("Structured FAQ items for this cooperative"),
                        fieldWithPath("data.translations[].metaRobots").description("Instructions for search engine crawlers"),
                        fieldWithPath("data.translations[].socialShareImage").description("Specific image optimized for social sharing"),
                        fieldWithPath("data.translations[].contentLastReviewed").description("When this content was last reviewed for accuracy"),
                        fieldWithPath("data.translations[].version").description("Version tracking for content changes"),
                        fieldWithPath("data.primaryMedia").description("Primary media items for this cooperative (one per type)")
                    )
                )
            )
    }
        ...
        mockMvc.perform(
            ...
            .andDo(
                document(
                    ...
                    preprocessResponse(prettyPrint()),
                    pathParameters(
                        parameterWithName("id").description("The ID of the cooperative to update")
                    ),
                    requestFields(
                        fieldWithPath("code").description("Updated code/slug for the cooperative"),
                        fieldWithPath("defaultLocale").description("Updated default locale for this cooperative's content"),
                        fieldWithPath("establishedDate").description("Updated date when the cooperative was established"),
                        fieldWithPath("ward").description("Updated ward where the cooperative is located"),
                        fieldWithPath("type").description("Updated type of cooperative"),
                        fieldWithPath("status").description("Updated status of the cooperative"),
                        fieldWithPath("registrationNumber").description("Updated registration number of the cooperative"),
                        fieldWithPath("point").description("Updated geographic point location"),
                        fieldWithPath("point.longitude").description("Updated longitude coordinate"),
                        fieldWithPath("point.latitude").description("Updated latitude coordinate"),
                        fieldWithPath("contactEmail").description("Updated contact email for the cooperative"),
                        fieldWithPath("contactPhone").description("Updated contact phone number"),
                        fieldWithPath("websiteUrl").description("Updated website URL of the cooperative")
                    ),
                    responseFields(
                        fieldWithPath("success").description("Indicates if the request was successful"),
                        fieldWithPath("message").description("Success message"),
                        fieldWithPath("data").description("Updated cooperative data"),
                        fieldWithPath("data.id").description("Unique identifier for the cooperative"),
                        fieldWithPath("data.code").description("Updated code/slug for the cooperative"),
                        fieldWithPath("data.defaultLocale").description("Updated default locale for this cooperative's content"),
                        fieldWithPath("data.establishedDate").description("Updated date when the cooperative was established"),
                        fieldWithPath("data.ward").description("Updated ward where the cooperative is located"),
                        fieldWithPath("data.type").description("Updated type of cooperative"),
                        fieldWithPath("data.status").description("Updated status of the cooperative"),
                        fieldWithPath("data.registrationNumber").description("Updated registration number of the cooperative"),
                        fieldWithPath("data.point").description("Updated geographic point location"),
                        fieldWithPath("data.point.longitude").description("Updated longitude coordinate"),
                        fieldWithPath("data.point.latitude").description("Updated latitude coordinate"),
                        fieldWithPath("data.contactEmail").description("Updated contact email for the cooperative"),
                        fieldWithPath("data.contactPhone").description("Updated contact phone number"),
                        fieldWithPath("data.websiteUrl").description("Updated website URL of the cooperative"),
                        fieldWithPath("data.createdAt").description("When this record was created"),
                        fieldWithPath("data.updatedAt").description("When this record was last updated"),
                        fieldWithPath("data.translations").description("Translations for this cooperative"),
                        fieldWithPath("data.translations[].id").description("Unique identifier for the translation"),
        ...
        mockMvc.perform(
            ...
            .andDo(
                document(
                    ...
                    preprocessResponse(prettyPrint()),
                    pathParameters(
                        parameterWithName("id").description("The ID of the cooperative to retrieve")
                    ),
                    responseFields(
                        fieldWithPath("success").description("Indicates if the request was successful"),
                        fieldWithPath("message").description("Success message"),
                        fieldWithPath("data").description("Cooperative data"),
                        fieldWithPath("data.id").description("Unique identifier for the cooperative"),
                        fieldWithPath("data.code").description("Code/slug for the cooperative"),
                        fieldWithPath("data.defaultLocale").description("Default locale for this cooperative's content"),
                        fieldWithPath("data.establishedDate").description("Date when the cooperative was established"),
                        fieldWithPath("data.ward").description("Ward where the cooperative is located"),
                        fieldWithPath("data.type").description("Type of cooperative"),
                        fieldWithPath("data.status").description("Status of the cooperative"),
                        fieldWithPath("data.registrationNumber").description("Registration number of the cooperative"),
                        fieldWithPath("data.point").description("Geographic point location"),
                        fieldWithPath("data.point.longitude").description("Longitude coordinate"),
                        fieldWithPath("data.point.latitude").description("Latitude coordinate"),
                        fieldWithPath("data.contactEmail").description("Contact email for the cooperative"),
                        fieldWithPath("data.contactPhone").description("Contact phone number"),
                        fieldWithPath("data.websiteUrl").description("Website URL of the cooperative"),
                        fieldWithPath("data.createdAt").description("When this record was created"),
                        fieldWithPath("data.updatedAt").description("When this record was last updated"),
                        fieldWithPath("data.translations").description("Translations for this cooperative"),
        ...
        mockMvc.perform(
            ...
            .andDo(
                document(
                    ...
                    preprocessResponse(prettyPrint()),
                    pathParameters(
                        parameterWithName("code").description("The code of the cooperative to retrieve")
                    ),
                    responseFields(
                        fieldWithPath("success").description("Indicates if the request was successful"),
                        fieldWithPath("message").description("Success message"),
            ...
            .andDo(
                document(
                    ...
                    responseFields(
                        fieldWithPath("success").description("Indicates if the request was successful"),
                        fieldWithPath("message").description("Success message"),
                        fieldWithPath("data.content").description("List of cooperatives"),
        ...
        mockMvc.perform(
            ...
            .andDo(
                document(
                    ...
                    preprocessResponse(prettyPrint()),
                    pathParameters(
                        parameterWithName("id").description("The ID of the cooperative to delete")
                    ),
                    responseFields(
                        fieldWithPath("success").description("Indicates if the request was successful"),
                        fieldWithPath("message").description("Success message indicating cooperative was deleted")
                    )
                )
            )
    }
    ...
    @Test
    @WithMockUser(authorities = ["PERMISSION_UPDATE_COOPERATIVE"])
    fun `should change cooperative status`() {
        // First create a cooperative to update
        val cooperativeId = createTestCooperative().id!!

        mockMvc.perform(
            patch("/api/v1/cooperatives/{id}/status", cooperativeId)
                .contentType(MediaType.APPLICATION_JSON)
            ...
            .andDo(
                document(
                    ...
                    queryParameters(
                        parameterWithName("status").description("The new status for the cooperative")
                    ),
                    responseFields(
                        fieldWithPath("success").description("Indicates if the request was successful"),
                        fieldWithPath("message").description("Success message"),
    ...
    @Test
    fun `should return 401 when creating cooperative without authentication`() {
        val translation = CreateCooperativeTranslationDto(
            locale = "ne",
            name = "उपाली कृषि सहकारी संस्था लिमिटेड",
            description = "यो एक कृषि सहकारी हो",
