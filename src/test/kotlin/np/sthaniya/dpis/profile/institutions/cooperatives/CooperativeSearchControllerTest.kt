                ...
                .andDo(
                        document(
                                ...
                                queryParameters(
                                        ...
                                        parameterWithName("distanceInMeters")
                ...
                .andDo(
                        document(
                                ...
                                responseFields(
                                        ...
                                        fieldWithPath("message").description("Success message"),
                                        fieldWithPath("data")
                                                .description("Map of cooperative types to counts"),
                                        fieldWithPath("data.DAIRY")
                                                .description("Count of dairy cooperatives")
                                                .optional(),
                                        fieldWithPath("data.AGRICULTURE")
                                                .description("Count of agriculture cooperatives")
                                                .optional(),
                                        fieldWithPath("data.SAVINGS_AND_CREDIT")
                                                .description(
                                                        "Count of savings and credit cooperatives"
                                                )
                                                .optional(),
                                        fieldWithPath("data.MULTIPURPOSE")
                                                .description("Count of multipurpose cooperatives")
                                                .optional()
                                        // Note: Only the types present in the test data will be in
                                        // the response
                                        )
                        )
                )
