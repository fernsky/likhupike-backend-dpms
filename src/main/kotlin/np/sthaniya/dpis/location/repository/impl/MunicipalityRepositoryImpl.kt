...
class MunicipalityRepositoryImpl(
    ...
    override fun findByTypeAndDistrict(
        type: np.sthaniya.dpis.location.domain.MunicipalityType,
        districtCode: String,
    ...
    override fun findByType(type: np.sthaniya.dpis.location.domain.MunicipalityType): List<Municipality> =
