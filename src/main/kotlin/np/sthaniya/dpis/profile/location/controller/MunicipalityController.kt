...
class MunicipalityController(
    ...
    @ApiResponses(value = [
        SwaggerResponse(responseCode = "200", description = "Municipality information retrieved or created successfully"),
    ...
    fun getOrCreateMunicipality(
        ...
        return ResponseEntity.ok(
            ApiResponse.success(
                data = municipality,
                message = i18nMessageService.getMessage("municipality.create.success")
            )
        )
    }
    ...
    @ApiResponses(value = [
        SwaggerResponse(responseCode = "200", description = "Municipality information retrieved successfully"),
        SwaggerResponse(responseCode = "404", description = "Municipality not found")
    ])
    @GetMapping
    @PreAuthorize("hasPermission(null, 'MANAGE_PROFILE')")
    ...
    @ApiResponses(value = [
        SwaggerResponse(responseCode = "200", description = "Municipality information updated successfully"),
        SwaggerResponse(responseCode = "400", description = "Invalid input data"),
        SwaggerResponse(responseCode = "401", description = "Not authenticated"),
        SwaggerResponse(responseCode = "403", description = "Missing required permission"),
        SwaggerResponse(responseCode = "404", description = "Municipality not found")
    ...
    fun updateMunicipalityInfo(
        ...
        return ResponseEntity.ok(
            ApiResponse.success(
                data = municipality,
                message = i18nMessageService.getMessage("municipality.update.success")
            )
        )
    }
    ...
    @ApiResponses(value = [
        SwaggerResponse(responseCode = "200", description = "Municipality geo-location updated successfully"),
        SwaggerResponse(responseCode = "400", description = "Invalid input data"),
        SwaggerResponse(responseCode = "401", description = "Not authenticated"),
        SwaggerResponse(responseCode = "403", description = "Missing required permission"),
        SwaggerResponse(responseCode = "404", description = "Municipality not found")
    ...
    fun updateMunicipalityGeoLocation(
        ...
        return ResponseEntity.ok(
            ApiResponse.success(
                data = municipality,
                message = i18nMessageService.getMessage("municipality.geolocation.update.success")
            )
        )
    }
}
