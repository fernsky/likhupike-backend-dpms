...
class MajorSettlementAreasController(
    ...
    @ApiResponses(
            value =
                    [
                            SwaggerResponse(
                                    responseCode = "201",
                                    description = "Settlement area created successfully"
                            ),
                            SwaggerResponse(
                                    responseCode = "400",
                            ...
                            SwaggerResponse(
                                    responseCode = "404",
                                    description = "Referenced ward not found"
                            )]
    )
    @PostMapping
    ...
    @ApiResponses(
            value =
                    [
                            SwaggerResponse(
                                    responseCode = "200",
                                    description = "Settlement areas retrieved successfully"
                            ),
                            SwaggerResponse(
                                    responseCode = "401",
                                    description = "Not authenticated"
    ...
    @ApiResponses(
            value =
                    [
                            SwaggerResponse(
                                    responseCode = "200",
                                    description = "Settlement area retrieved successfully"
                            ),
                            SwaggerResponse(
                                    responseCode = "401",
                                    description = "Not authenticated"
                            ...
                            SwaggerResponse(
                                    responseCode = "404",
                                    description = "Settlement area not found"
                            )]
    )
    @GetMapping("/{id}")
    fun getSettlementById(
    ...
    fun getSettlementsByWard(
            @PathVariable wardId: UUID
    ): ResponseEntity<ApiResponse<List<MajorSettlementAreasResponse>>> {
    ...
    @ApiResponses(
            value =
                    [
                            SwaggerResponse(
                                    responseCode = "200",
                                    description = "Settlement area updated successfully"
                            ),
                            SwaggerResponse(
                                    responseCode = "400",
                                    description = "Invalid input data"
    ...
    @Operation(summary = "Delete settlement area", description = "Delete a settlement area")
    @ApiResponses(
            value =
                    [
                            SwaggerResponse(
                                    responseCode = "200",
                                    description = "Settlement area deleted successfully"
                            ),
                            SwaggerResponse(
                                    responseCode = "401",
                                    description = "Not authenticated"
