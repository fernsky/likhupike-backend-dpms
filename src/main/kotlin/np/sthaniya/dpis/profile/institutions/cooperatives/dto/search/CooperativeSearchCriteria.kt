...
/**
 * Search criteria for cooperative queries with pagination, filtering, and sorting support.
 * Used to filter and paginate cooperative data.
 *
 * Search Parameters:
...
data class CooperativeSearchCriteria(
    ...
    @Schema(
        description = "Generic search term that matches against name, description, and other text fields",
        example = "agriculture",
        nullable = true
    )
    ...
    @Schema(
        description = "Filter by text contained in cooperative name (in the specified locale)",
        example = "किसान",
        nullable = true
    )
     ...
     */
    @AssertTrue(message = "For geographic search, longitude, latitude, and radiusInMeters must all be provided")
