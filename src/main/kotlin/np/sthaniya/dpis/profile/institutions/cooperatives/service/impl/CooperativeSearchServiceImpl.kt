...
class CooperativeSearchServiceImpl(
    ...
    private val cooperativeRepositoryCustom: CooperativeRepositoryCustom
    ...
    override fun searchCooperatives(criteria: CooperativeSearchCriteria): Page<CooperativeProjection> {
        ...
        try {
            ...
            return cooperativeRepositoryCustom.findAllWithProjection(
                spec,
                criteria.toPageable(),
                columns,
            ...
            throw CooperativeException.ProximitySearchFailedException(
                "Failed to execute cooperative search", e
            )
        }
    }
    ...
    private fun handleGeoSearch(criteria: CooperativeSearchCriteria): Page<CooperativeProjection> {
        ...
        val results = cooperativeRepositoryCustom.findWithinDistance(
            criteria.longitude!!,
            criteria.latitude!!,
        ...
        // Map to projections
        val projections = results.content.map { cooperative ->
