 ...
 *
 * Sets up the MinIO client bean and ensures the required bucket exists. This configuration is only
 * active in non-test environments.
 *
...
class MinioConfig(private val storageProperties: StorageProperties) {
